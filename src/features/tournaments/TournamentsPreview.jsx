...
const TournamentsPreview = () => {
  return (
    <Section 
      title={tournamentsPreviewContent.title}
      subtitle={tournamentsPreviewContent.subtitle}
      className="bg-dark-50"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {tournamentsPreviewContent.tournaments.map((tournament, index) => (
      ...
      <div className="text-center mt-8">
        ...
        >
          {tournamentsPreviewContent.allTournamentsLinkText}
        </a>
      </div>
    </Section>
  )
